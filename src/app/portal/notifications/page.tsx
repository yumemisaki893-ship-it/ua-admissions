          ...
          <div className="flex items-center gap-2">
            ...
            {unread > 0 && (
              <form action={markAllNotificationsRead}>
                <button className="rounded-lg border border-crimson-200 bg-crimson-50 px-3 py-1.5 text-xs font-semibold text-crimson-700 transition-colors hover:bg-yellow-300 hover:text-crimson-900">
      ...
      <Card className="border-slate-200 bg-white shadow-sm">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-lg">
            <BellRing className="h-5 w-5 text-crimson-700" /> All Notifications
          </CardTitle>
        </CardHeader>
              ...
              <button
                ...
                className={`w-full rounded-xl border px-4 py-3.5 text-left transition-colors ${
                  n.read
                    ...
                    : "border-crimson-200 bg-crimson-50/60 hover:bg-yellow-50"
                }`}
              >
